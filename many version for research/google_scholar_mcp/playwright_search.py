...
async def wait_for_page_stable(page: Page, timeout: int = 10):
    try:
...
async def get_citing_papers(page: Page, citation_id: str, max_results: int = 100) -> list[dict]:
    all_papers = []
    start = 0
    page_num = 0
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            cited_by, citation_id = await search_paper(page, PAPER_TITLE)
            ...
            papers = await get_citing_papers(page, citation_id, MAX_RESULTS)
